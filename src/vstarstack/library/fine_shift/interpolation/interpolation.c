...
double interpolation_2d(double fm1m1, double f0m1, double f1m1, double f2m1,
                        ...
                        double x, double y)
{
    double fm1 = image_grid_interpolation_1d(fm1m1, fm10, fm11, fm12, y);
    double f0  = image_grid_interpolation_1d(f0m1,  f00,  f01,  f02,  y);
    double f1  = image_grid_interpolation_1d(f1m1,  f10,  f11,  f12,  y);
    double f2  = image_grid_interpolation_1d(f2m1,  f20,  f21,  f22,  y);
    return image_grid_interpolation_1d(fm1, f0, f1, f2, x);
}
